...
#Divide Q-values Q(s,a) into the value of the state V(s) anandd the advtange of actions in this state A(s,a)
#One path predict V(s) (single number) while the other path predicts A(s,a) same dimension as Q
